...
def normalize_mac(mac: str) -> str:
    """
    Normalize a MAC address by removing semicolons and converting it to lowercase.
    """
...
def append_keys_to_results(results_csv: Path, founds_txt: Path) -> None:
    ...
    try:
        ...
        print(f"Error reading {founds_txt}: {e}")
        return
    ...
    try:
        ...
        print(f"Updated {updated_count} rows in {results_csv}.")
    except Exception as e:
        print(f"Error writing {results_csv}: {e}")